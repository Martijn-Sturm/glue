...
logger = logging.Logger("upsert-table", logging.LogLevel.DEBUG)
...
SCHEMA = spark_types.StructType(
    [
        ...
        # spark_types.StructField("datetime", spark_types.StringType(), True),
...
demo_table = HudiGlueTable(storage_location=StorageLocation(table_uri))
